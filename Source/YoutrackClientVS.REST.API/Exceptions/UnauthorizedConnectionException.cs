...
{
    /// <summary>
    /// Represents an exception thrown by <see cref="T:Connection" /> when authentication
        ...
        : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:UnauthorizedConnectionException" /> class
