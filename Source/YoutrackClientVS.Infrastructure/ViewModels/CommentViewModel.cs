...
namespace YouTrackClientVS.Infrastructure.ViewModels
{
    ...
    public class CommentViewModel : ViewModelBase, ICommentViewModel
    {
        ...
        public CommentViewModel(IYouTrackClientService youTrackClientService, ITreeStructureGenerator treeStructureGenerator, IUserInformationService userInformationService)
        {
        ...
        public async Task UpdateComments(long pullRequestId)
        {
            ...
            Comments = (await _youTrackClientService.GetPullRequestComments(PullRequestId)).ToList();
